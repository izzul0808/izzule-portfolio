...
if(isset($_POST['update'])) {   
    ...
    if($result) {
        ...
        <h2>Update Data Couriers</h2><br><br>
        <br><div class="title">Courier Details</div>
            ID: <?php  echo $id; ?><br>
        ...
        <div class=" line "></div><br><br>
            ...
            Delivery Man <br><input type="text" name="deliveryman" id="deliveryman" value="<?php  echo $deliveryman; ?>"><br>
            Courier <br><input type="text" name="type" id="type" value="<?php  echo $type; ?>"><br>
            Total Parcel <br><input type="text" name="total" id="total" value="<?php  echo $total; ?>"><br>
            Staff Name <br><input type="text" name="staff" id="staff" value="<?php  echo $staff; ?>"><br>
